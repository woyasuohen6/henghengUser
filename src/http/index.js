...
class Https {
   ...
   * 验证登录状态
   */
  verifyLogin = () => HttpUtils.get('/users/verify')
   ...
   *   password: 密码
   * */
  postLogin = parmas => HttpUtils.post('/users/login', parmas)

  /** 
   * 注册
   */
  postRegister = parmas => HttpUtils.post('/users/register', parmas)

  /**
   * 获取首页数据
   */
  getHomeData = params => HttpUtils.get('users/getHomeData', params)
   ...
   *   merchantId: 商户ID
   * */
  getBrandDetail = parmas => HttpUtils.get('/merchants/getMerchantDetail', parmas)
   ...
   *   merchantId:商户Id
   * */
  getGoodsData = parmas => HttpUtils.get('/commoditys/getCommodityList', parmas)
   ...
   *   typeId:类别ID
   * */
  getTypedGoodsData = parmas => HttpUtils.get('/commoditys/getTypedCommodityList', parmas)
   ...
   *   id: 商品id
   * */
  getGoodsDetail = (parmas = {}) => HttpUtils.get('/commoditys/getCommodityDetail', parmas)
